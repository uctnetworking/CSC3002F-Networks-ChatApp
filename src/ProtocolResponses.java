...
{
    public static final String ENTER_YOUR_NAME = "Please enter your name and press return...";
    public static final String NAME_SUCCESS = "Name successfully registered, you are now online";
    public static final String NAME_TOO_LONG = "Error registering name: Please enter a name less than 24 characters long";
    ...
    public static final String NOTIFY_LOGOUT = "L";
